const prepareOpenFileMessage = require('../lib/utils').prepareOpenFileMessage;
...
function openFileInIDE(openPath) {
  getProjectPath(path.dirname(openPath))
    .subscribe(x => {
      console.log(Messages.OPENING_ANGULAR_IDE, openPath);

      const actualProjectPath = x[1];

      const commandMessage = prepareOpenFileMessage(openPath);
